                ...
                listeners.lock().unwrap().retain(|listener| {
                    listener
                        .send(ThumbwheelEvent {
                            ...
                            rotation_status: match payload[4] {
                                0 => ThumbwheelRotationStatus::Inactive,
                                1 => ThumbwheelRotationStatus::Start,
                                2 => ThumbwheelRotationStatus::Active,
                                _ => ThumbwheelRotationStatus::Stop,
                            },
...
impl ThumbwheelFeatureV0 {
    ...
    pub async fn get_thumbwheel_info(&self) -> Result<ThumbwheelInfo, Hidpp20Error> {
        ...
        Ok(ThumbwheelInfo {
            ...
            default_direction: if payload[4] & 1 != 0 {
                ThumbwheelDirection::PositiveWhenRightOrFront
            } else {
                ThumbwheelDirection::PositiveWhenLeftOrBack
            },
    ...
    pub async fn set_thumbwheel_reporting(
        ...
        self.chan
            .send_v20(v20::Message::Short(
                ...
                [
                    if mode == ThumbwheelReportingMode::Native {
                        0
                    } else {
                        1
                    },
...
pub enum ThumbwheelDirection {
    PositiveWhenLeftOrBack,
    PositiveWhenRightOrFront,
}
